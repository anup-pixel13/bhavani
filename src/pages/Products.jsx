      ...
      <div className="container">
        ...
        <div className="products-header">
          <div className="section-heading">
            ...
            <p>
              Browse our range of professional-grade security and networking
              equipment. All products are available for enquiry — no online
              checkout.
            </p>
          </div>
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((n) => (
                <button
                  ...
                  className={`pagination__page${
                    n === currentPage ? " pagination__page--active" : ""
                  }`}
                  onClick={() => goToPage(n)}
                  aria-label={`Page ${n}`}
