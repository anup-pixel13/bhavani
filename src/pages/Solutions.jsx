    ...
    <section className="page-section solutions-page">
      <div className="container">
        ...
        <div className="section-heading">
          ...
          <p>
            In addition to CCTV and networking, we provide advanced security
            solutions including biometric access control, video door phones,
            EPABX systems, and annual maintenance contracts.
          </p>
        </div>
          ...
          {solutions.map((sol) => (
            <article key={sol.title} className="solution-card card">
              <div className="solution-card__image-wrap">
                <div className="solution-card__image-fallback">
